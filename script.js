...
const displayAverageSalary = function(employeesArray) {
  ...
  // This calculates total salary of every employee
  ...
  // This calculates average salary of every employee
  if (arrayLength > 0) {
      averageSalary = totalSalary / arrayLength;
  }

  console.log(`The average employee salary between our ${arrayLength} employee(s) is $${averageSalary}`);
}
